package com.bgsoftware.wildstacker.nms.v26_2.spawner;
...
public class SyncedCreatureSpawnerImpl extends CraftBlockEntityState<SpawnerBlockEntity> implements SyncedCreatureSpawner {
    ...
    public void setSpawnedType(EntityType entityType) {
        if (entityType != null && entityType.getName() != null) {
            net.minecraft.world.entity.EntityType nmsEntityType;
            try {
                nmsEntityType = CraftEntityType.bukkitToMinecraft(entityType);
            } catch (Throwable error) {
                nmsEntityType = net.minecraft.world.entity.EntityTypes.PIG;
            }
            getSpawner().setEntityId(nmsEntityType, this.world.getHandle(),
                    this.world.getHandle().getRandom(), this.getPosition());
        } else {
    ...
    public void setSpawnedItem(org.bukkit.inventory.ItemStack bukkitItem) {
        ...
        try (ProblemReporter.ScopedCollector scopedCollector =
            ...
            tagValueOutput.putString("id", BuiltInRegistries.ENTITY_TYPE.getKey(net.minecraft.world.entity.EntityTypes.ITEM).toString());
